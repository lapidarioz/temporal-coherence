...
class PreprocessedFrameDataGenerator(FrameDataGenerator):
    ...
    def next_loss(self):
        ...
        total_gen_loss, gan_loss, main_loss, coherence_loss, landmarks_loss, landmarks_coherence_loss, perceptual_loss_value, interpolation_loss_value = self.generator_loss_function(
        ...
        return total_gen_loss, disc_loss_value, gan_loss, main_loss, coherence_loss, landmarks_loss, landmarks_coherence_loss, perceptual_loss_value, interpolation_loss_value
